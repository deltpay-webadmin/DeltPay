        ...
        <div style={{
          ...
          {tiers.map((tier, i) => (
            <div key={i} style={{
              background: COLORS.white,
              borderRadius: 16,
              border: tier.bundle ? `2px solid ${COLORS.indigo}` : `1px solid ${COLORS.gray200}`,
              padding: "32px 28px",
              position: "relative",
              boxShadow: tier.bundle ? `0 8px 32px rgba(73,69,255,0.12)` : "0 1px 3px rgba(0,0,0,0.04)",
              display: "flex",
