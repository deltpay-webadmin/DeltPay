...
const features = [
  {
    ...
    desc: 'Tell us about your business. We do the rest — your site goes live in days, not months.',
    bullets: ['Looks great on every phone, tablet, and computer', 'Customers find you on Google — and trust what they see', 'Start taking orders the same day you go live'],
  ...
  },
  {
    ...
    accentWord: 'every',
    desc: 'No more spreadsheets or guessing. Just a clear picture of what\u2019s making money — and what\u2019s not.',
    bullets: ['See which days, items, and customers bring you the most money', 'Get a heads-up before cash gets tight', 'Know what to do next — not just what already happened'],
    img: img2,
    href: '/delt-ai',
  },
  {
    ...
    accentWord: 'Honest',
    desc: 'Every swipe, tap, and online sale goes straight to you — with nothing skimmed off the top.',
    bullets: ['Keep more of every sale — no hidden fees, no surprises', 'Money in your bank by the next morning', 'Card readers that work the day you open the box'],
    img: img3,
    href: '/payments',
  },
  {
    badge: 'Capital',
    title: 'Cash waiting in your dashboard.',
    accentWord: 'Cash',
    desc: 'We already see your sales — that\u2019s your application. Most owners get funded in under 48 hours.',
    bullets: ['Approved on your sales, not your credit score', 'Banks take weeks. We don\u2019t make you wait.', 'Pay back a little less when business is slow'],
    img: img4,
    href: '/apply',
  },
];
