...
const features = [
  {
    ...
    accentWord: 'stunning',
    desc: 'Tell us about your business. We handle the design, the build, and the launch — start to finish.',
  ...
  },
  {
    ...
    title: 'Your numbers,\nworking for you.',
    accentWord: 'working',
    desc: 'No spreadsheets. No busywork. Just a clear picture of what\'s driving your business — in real time.',
    bullets: ['See which days, products, and customers drive profit', 'Know when a cash shortfall is coming before it hits', 'Insights you can act on — not just reports of what happened'],
