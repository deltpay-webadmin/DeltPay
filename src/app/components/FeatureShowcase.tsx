...
const features = [
  {
    ...
    desc: 'Flat 2.6% + $0.10 — or 0% with our Cash Discount program. Every swipe, tap, and online payment lands in your account with nothing skimmed off the top.',
    bullets: ['Flat-rate or Cash Discount — you pick what fits your margin', 'Money in your account next-day, standard', 'Card-present, card-not-present, mobile, and online — one stack'],
    img: img3,
    href: '/payments',
  },
  {
    ...
    accentWord: 'Capital',
    desc: "We already see your processing volume. That's your application. Most merchants are funded in under 48 hours.",
    bullets: ['Approved on revenue, not your credit score', 'Traditional lenders take weeks. We don\'t.', 'Repayment that flexes with your slow seasons'],
    img: img4,
    href: '/apply',
  },
  {
    ...
    title: 'A site that\nsells day one.',
    accentWord: 'sells',
    desc: 'Tell us about your business. We build the rest — with Delt Payments wired in so checkout works the moment you go live.',
  ...
  },
  {
    ...
    accentWord: 'every',
    desc: 'No spreadsheets. No guessing. Just a clear picture of what\'s working — and what to fix — driven by your processing data.',
