...
/* Plaid OAuth return shim. OAuth banks redirect back to the registered
   ...
   real path /plaid-oauth (served by the Vercel SPA rewrite). Stash the full
...
export default function App() {
  return (
    <>
      <CustomCursor />
      {/* First-party traffic + funnel analytics (free Web Analytics).
          Data flows once "Web Analytics" is enabled on the Vercel project. */}
      <Analytics />
      <HashRouter>
        <ScrollToTop />
        <PixelRouteTracker />
