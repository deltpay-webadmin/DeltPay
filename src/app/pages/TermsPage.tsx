        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <p className="text-[#475569] leading-relaxed">
                We reserve the right to modify these Terms at any time. We will provide notice of material changes via email or through the Services. Continued use of the Services after changes constitutes acceptance of the updated Terms. For material changes that adversely affect your rights or increase your fees, we will provide at least 30 days' advance notice. If you do not agree, you may close your account.
              </p>
            </div>
