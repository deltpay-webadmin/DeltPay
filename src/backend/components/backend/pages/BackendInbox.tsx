...
import {
  ...
  Paperclip, Star, StarOff, Archive, Reply, Forward, FileText,
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {filtered.length === 0 && (
              <div className="px-5 py-16 text-center">
                ...
                <p className="text-sm text-gray-400">{threads.length === 0 ? 'No conversations yet — merchant emails, SMS, and call logs will appear here once outreach begins.' : 'No conversations match your filters'}</p>
              </div>
            )}
          </div>
        </div>
