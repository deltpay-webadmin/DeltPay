              ...
              >
                ...
                {p.key === 'interchange_plus' && p.icBaseMonthly != null && p.icMarginMonthly != null && (
                  <p className="mt-2 text-[11px] text-gray-500 leading-snug">
                    {t('Your interchange cost at published rates:')} <span className="font-semibold text-gray-700 tabular-nums">{fmt(p.icBaseMonthly)}/mo</span>
                    {' '}{t('+ Delt margin')} <span className="font-semibold text-gray-700 tabular-nums">{fmt(p.icMarginMonthly)}/mo</span>
                  </p>
                )}
