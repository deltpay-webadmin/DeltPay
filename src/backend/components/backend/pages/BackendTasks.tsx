    ...
    <div className="px-6 py-6 space-y-5">
      ...
      {view === 'board' && filtered.length === 0 ? (
        <div className="bg-white rounded-[8px] border border-gray-200 px-5 py-16 text-center">
          ...
          <p className="text-sm text-gray-400">{tasks.length === 0 ? 'No tasks yet — compliance, collections, and sales work items will appear here.' : 'No tasks match your filters'}</p>
        </div>
      ) : view === 'board' ? (
