        ...
        <div className="bg-white rounded-[8px] border border-gray-200 overflow-hidden">
          ...
          {filtered.length === 0 && (
            <div className="px-5 py-16 text-center">
              ...
              <p className="text-sm text-gray-400">{tasks.length === 0 ? 'No tasks yet' : 'No tasks match your filters'}</p>
              {tasks.length === 0 && <p className="text-xs text-gray-400 mt-1">Create a task to get started</p>}
            </div>
          )}
        </div>
      )}
