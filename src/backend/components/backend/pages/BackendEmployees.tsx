    ...
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-full max-w-xl bg-white shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          {detailTab === 'reviews' && (
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-[8px] p-8 flex flex-col items-center text-center">
                <FileText className="w-6 h-6 text-gray-400 mb-2" />
                <p className="text-sm text-gray-500">No reviews yet — performance reviews appear here once completed.</p>
              </div>
    ...
    <div className="h-full flex flex-col bg-canvas">
      ...
      <div className="px-6 py-6 flex-1 overflow-y-auto space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard label="Open Positions" value={openPositions.toString()} icon={<Briefcase className="w-5 h-5" />} sub="Roles currently recruiting" />
                ...
                {filtered.length === 0 && (
                  <tr>
                    <td colSpan={8} className="px-5 py-12 text-center">
                      ...
                      <p className="text-sm text-gray-500">No employees yet — use Add Employee to build your roster.</p>
                    </td>
                  </tr>
                )}
                {filtered.map(emp => (
