        ...
        {filtered.length === 0 && (
          agentList.length === 0 ? (
            <div className="px-5 py-12 text-center">
              ...
              <p className="text-sm font-medium text-gray-900">No agents yet</p>
              <p className="text-xs text-gray-500 mt-1">Onboard an agent to start tracking portfolios, commissions, and pipeline.</p>
            </div>
          ) : (
  ...
  return (
    <div className="px-6 py-6 space-y-6">
      ...
      <div className="bg-white rounded-[8px] border border-gray-200">
        ...
        {/* Tab Content */}
        {tab === 'portfolio' && merchants.length === 0 && (
          <div className="px-5 py-12 text-center">
            <Store className="w-8 h-8 text-gray-300 mx-auto mb-3" />
            <p className="text-sm font-medium text-gray-900">No merchants yet</p>
            <p className="text-xs text-gray-500 mt-1">Merchants appear here once deals are boarded to this agent.</p>
          </div>
        )}
        {tab === 'portfolio' && merchants.length > 0 && (
          <div className="overflow-x-auto">
        ...
        {tab === 'commissions' && commHistory.length === 0 && (
          <div className="px-5 py-12 text-center">
            <DollarSign className="w-8 h-8 text-gray-300 mx-auto mb-3" />
            <p className="text-sm font-medium text-gray-900">No commission history yet</p>
            <p className="text-xs text-gray-500 mt-1">Monthly statements appear here after the first payout cycle.</p>
          </div>
        )}
        {tab === 'commissions' && commHistory.length > 0 && (
          <div className="overflow-x-auto">
        ...
        {tab === 'pipeline' && pipeline.length === 0 && (
          <div className="px-5 py-12 text-center">
            ...
            <p className="text-sm font-medium text-gray-900">No pipeline yet</p>
            <p className="text-xs text-gray-500 mt-1">Leads submitted by this agent appear here.</p>
          </div>
        )}
        {tab === 'pipeline' && pipeline.length > 0 && (
          <div>
