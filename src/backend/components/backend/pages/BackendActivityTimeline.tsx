      ...
      <div className="bg-white rounded-[8px] border border-gray-200">
        ...
        {filtered.length === 0 && (
          <div className="px-5 py-16 text-center">
            ...
            <p className="text-sm text-gray-400">{ACTIVITIES.length === 0 ? 'No activity yet — calls, emails, payments, and system events will appear here as they happen.' : 'No activities match your filters'}</p>
          </div>
        )}
      </div>
