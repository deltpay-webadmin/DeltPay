          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input value={form.merchantName} onChange={e => up({ merchantName: e.target.value })} className={inputCls} placeholder="Sample Business LLC" />
              </div>
              <div>
                <label className={labelCls}>Legal Name</label>
                <input value={form.merchantLegalName} onChange={e => up({ merchantLegalName: e.target.value })} className={inputCls} placeholder="Sample Business LLC" />
              </div>
              <div>
