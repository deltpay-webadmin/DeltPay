          ...
          <div className="flex-1 overflow-y-auto divide-y divide-gray-100">
            ...
            {filteredInbox.length === 0 && (
              <div className="py-16 text-center">
                ...
                <p className="text-sm text-gray-400">{INBOX_THREADS.length === 0 ? 'No conversations yet' : 'No conversations match your search'}</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {filteredActivities.length === 0 && (
              <div className="py-16 text-center">
                ...
                <p className="text-sm text-gray-400">{ACTIVITIES.length === 0 ? 'No activity yet' : 'No activity matches your search'}</p>
              </div>
            )}
          </div>
        </div>
