...
// qualified → converted for Meta-sourced leads. Until an ad account connects
// the page shows an honest empty state, never fabricated numbers.
// ══════════════════════════════════════
...
export function BackendMarketing() {
  ...
  // No ad account connected (or no insights yet) — page shell with an honest
        ...
        <div className="max-w-[1360px] mx-auto px-4 lg:px-8 py-6 space-y-6">
          <Card title="Marketing performance">
            <div className="flex flex-col items-center justify-center text-center py-14">
              <Overline>No ad account connected</Overline>
              <p className="mt-2 max-w-md text-[13px] text-(--dp-text-muted)">
                Connect a Meta Ads account to see real spend, cost per lead, the funnel from
                impressions to converted merchants, and lead reconciliation against the CRM.
              </p>
              <div className="mt-5">
                <Btn variant="primary" size="sm" onClick={() => setConnectOpen(true)}>
                  <Link2 className="w-3.5 h-3.5" /> Connect Meta Ads
                </Btn>
              </div>
            </div>
          </Card>
