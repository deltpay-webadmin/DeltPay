              ...
              <>
                  ...
                  {merchantView ? (
                    ...
                    <div className="flex items-center gap-2 text-sm text-emerald-600 font-medium">
                      ...
                      {files[0]?.name
                        ...
                        : <>{t('Saved analysis')} — {extracted.merchantName} · {extracted.statementPeriod}</>}
                  ...
                  <div className="bg-white rounded-[8px] border border-gray-200 overflow-hidden">
                    ...
                    <div className="px-5 py-4 space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <MetaField label={t('Pricing Model')} value={PRICING_MODEL_LABELS[extracted.pricingModel] ?? extracted.pricingModel} />
                        ...
                        {extracted.refundsVolume > 0 && <MetaField label={t('Refunds')} value={fmt(extracted.refundsVolume)} />}
                        {extracted.netDeposits > 0 && <MetaField label={t('Net Deposits')} value={fmtWhole(extracted.netDeposits)} />}
                      </div>
                ...
                <div className="bg-white rounded-[8px] border border-gray-200 overflow-hidden">
                  <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-xs text-gray-400 hidden sm:inline">{t('Select a program to update the proposal')}</span>
